...
public class IkanList extends AppCompatActivity {

    RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;

    FirebaseDatabase database;
    DatabaseReference ikanList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ikan_list);

        //Firebase
        database = FirebaseDatabase.getInstance();
        ikanList = database.getReference("Ikan");
    ...
    private void loadSuggest() {
        ikanList.orderByChild("MenuId").equalTo(categoryId).addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void loadListFood(String categoryId) {
        ...
        adapter = new FirebaseRecyclerAdapter<Food, FoodViewHolder>(Food.class,R.layout.ikan_item,FoodViewHolder.class,ikanList.orderByChild("MenuId").equalTo(categoryId)) {
            @Override
            protected void populateViewHolder(FoodViewHolder viewHolder, Food model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        //Mulai Activity Baru
                        Intent foodDetail = new Intent(IkanList.this,SignIn.class);
