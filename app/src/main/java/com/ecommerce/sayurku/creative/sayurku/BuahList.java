...
public class BuahList  extends AppCompatActivity {

    RecyclerView recyclerView;
    RecyclerView.LayoutManager layoutManager;

    FirebaseDatabase database;
    DatabaseReference buahList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buahList = database.getReference("Buah");
    ...
    private void loadSuggest() {
        buahList.orderByChild("MenuId").equalTo(categoryId).addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void loadListFood(String categoryId) {
        ...
        adapter = new FirebaseRecyclerAdapter<Food, FoodViewHolder>(Food.class,R.layout.buah_item,FoodViewHolder.class,buahList.orderByChild("MenuId").equalTo(categoryId)) {
            @Override
            protected void populateViewHolder(FoodViewHolder viewHolder, Food model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        //Mulai Activity Baru
                        Intent foodDetail = new Intent(BuahList.this,SignIn.class);
